...
const Reviews = () => {
  return (
    <section className="z-10 flex w-full flex-col items-center justify-center overflow-hidden bg-[#0E1016] bg-cover bg-center pt-20 md:pb-16 lg:pb-24">
      ...
      >
        <AnimatedWords2
          // TEXTO TRADUCIDO: Testimonials -> Testimonios
          title={"Testimonios"} 
        ...
        />
        <AnimatedBody
          // TEXTO TRADUCIDO: Real Stories... -> Historias Reales...
          text="Historias Reales de Clientes y Colaboradores que Han Experimentado Mi Trabajo de Primera Mano"
          className="w-[90%] text-center text-[14px] font-semibold uppercase sm:w-[500px] md:w-[550px] md:text-[16px]"
        />
      </div>
      
      {/* NUEVA LÍNEA AGREGADA: Introducción a los colaboradores */}
      <AnimatedBody
          text="Personas clave en mi trayectoria y proyectos de colaboración"
          // Se usa un estilo más discreto pero visible, con algo de margen inferior
          className="w-[90%] text-center text-[18px] font-semibold tracking-wider text-[#95979D] mb-10 sm:w-[700px] md:text-[20px]"
        />
